...
test.describe('Verify that clicking the Checkout button on the Cart Page redirects to the Informati',async()=>{
    let Login : LoginPage 
    let Product : productPage
    let Cart : cartPage
    let checkout : checkoutPage
    test('Verify that clicking the Checkout button on the Cart Page redirects to the Informati  ', async ({ page }) => {
...
await test.step('5 -Verify that clicking the Checkout button on the Cart Page redirects to the Informati', async () => {
