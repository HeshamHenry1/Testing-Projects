...
test.describe('Check Multiple Products Are Added to Cart Successfully',async()=>{
    let Login : LoginPage 
    let Product : productPage
    let Cart : cartPage
    test('Check Multiple Products Are Added to Cart Successfully  ', async ({ page }) => {
    ...
    await test.step('5 -Check Multiple Products Are Added to Cart Successfully ', async () => {
        await cart.addMultipleProductsToCartAndVerify(3)
