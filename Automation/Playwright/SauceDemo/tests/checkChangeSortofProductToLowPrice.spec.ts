...
test.describe('check change sort of product to Low Price',async()=>{
    let Login : LoginPage 
    let Product : productPage
    test('check change sort of product to Low Price  ', async ({ page }) => {
       ...
       await test.step('5- change sort product and  check sort of  products to Low Price  ',async()=>{
        await product.checkSortByPriceLowToHigh()
       })
